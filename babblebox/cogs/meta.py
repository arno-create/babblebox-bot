...
HELP_PAGES: list[dict[str, str]] = [
    ...
    },
    {
        ...
        "body": (
            ...
            "Configured anti-spam stays explainable: admins set message and near-duplicate thresholds, GIF incidents are grouped per offender and window, and bot or webhook posts stay on a more conservative scam threshold unless the evidence is genuinely strong.\n"
