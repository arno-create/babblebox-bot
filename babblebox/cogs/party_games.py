...
class PartyGamesCog(commands.Cog):
    ...
    @commands.hybrid_group(name="hunt", with_app_command=True, description="Pattern Hunt status and structured guesses", invoke_without_command=True)
    ...
    @hunt_group.command(name="guess", with_app_command=True, description="Submit a 1-3 family Pattern Hunt theory")
